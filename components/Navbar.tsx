...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-md flex h-20 items-center justify-between sm:px-5 lg:px-8 bg-white">
                ...
                {/* Logo centered */}
                <h1 className="absolute left-1/2 transform -translate-x-1/2 text-primary text-2xl font-semibold">
            ...
            {isMenuOpen && (
                <div ref={menuRef} className="fixed top-20 left-0 w-full bg-white shadow-md z-40 flex flex-col gap-3 px-6 py-4 text-sm font-medium text-gray-700">
